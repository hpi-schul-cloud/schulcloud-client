...
module.exports = [
	...
	},
	{
		...
		team: [
			...
			},
			{
				...
				lastName: 'Malchow',
				position: 'Wissenschaftlicher Mitarbeiter, HPI',
				description: 'Martin hat im Bachelor „Angewandte Informatik“ studiert und einen Masterabschluss in „Automotive Software Engineering“. Er unterrichtete während dieser Zeit bereits einige Jahre die Grundlagen von eingebetteten Systemen in der Automobilindustrie. Derzeit ist er Mitarbeiter am Lehrstuhl für Internet-Technologien und Systeme und zuständig für das tele-TASK Portal des Hasso-Plattner-Instituts. Außerdem unterrichtet er HPI-Studenten unter anderem in den Fächern „Internet- und WWW-Technologien“ sowie „Web-Programmierung und Web-Frameworks“. Nach Abschluss seiner Dissertation, in der sich alles um die Unterstützung und Motivation im E-Learning dreht, unterstützt er das HPI Schul-Cloud-Team als IT-Sicherheitsbeauftragter. Zusätzlich ist er im Bereich des Video-Streamings und der Webdienstanbindung tätig. In der Freizeit findet man Martin meist im Leichtathletik-Stadion, bei einer Aktivität in/auf der Havel oder beim Bereisen der Welt.',
				pictureUrl: '/images/team/Martin_Malchow.jpg',
				priority: 0,
				social: {
					facebook: '',
					twitter: '',
			...
			},
			{
				...
				lastName: 'Morel',
				position: 'Wissenschaftlicher Mitarbeiter, HPI',
				description: 'Florian kommt gebürtig aus Frankreich und hat seinen Bachelor in Computer Science an der Universität Le Havre abgeschlossen. Bevor er 2018 ans HPI kam, hat er fünf Jahre als Mobile Engineer gearbeitet und sich auf die IOS Plattform spezialisiert. Im Projekt HPI Schul-Cloud ist Florian daher für die Entwicklung der IOS Version der HPI Schul-Cloud App zuständig. In seiner Freizeit genießt er das Leben mit seiner jungen Familie, sportlichen Aktivitäten und Gin Tonics.',
				pictureUrl: '/images/team/Florian_Morel.jpg',
				priority: 0,
				social: {
					facebook: '',
					twitter: '',
...

	{
		...
		team: [
			{
				title: '',
				firstName: 'Josafat-Mattias',
				lastName: 'Burmeister',
				position: 'Studentische Hilfskraft',
				description: 'Josafat-Mattias studiert derzeit im Bachelorstudiengang IT-Systems Engineering am Hasso-Plattner-Institut. Zuvor hat er bereits einen Bachelorabschluss in Biologie erworben. Seit April 2019 unterstützt er das Team der HPI Schul-Cloud als Fullstack-Entwickler. In seiner Freizeit beschäftigt er sich mit Fotografie und spielt gern Fussball.',
				pictureUrl: '/images/team/josafat-mattias_burmeister.jpeg',
				priority: 0,
				social: {
					facebook: '',
					twitter: '',
			...
			{
				title: '',
				firstName: 'Florian Michael',
				lastName: 'Kunz',
				position: 'Studentische Hilfskraft',
				description: 'Florian arbeitete über 20 Jahre als Geschäftsführer bei einem Internetdienstleister, bevor er 2017 das BWL-Studium an der Universität Potsdam begann. Neben dem Studium arbeitet er für das Projekt HPI Schul-Cloud, wobei zu seinen Aufgaben die Recherche und Dokumentation zählen. In seiner Freizeit ist er häufig mit dem Fahrrad unterwegs oder treibt Sport in und auf dem Wasser.',
				pictureUrl: '/images/team/Florian_Kunz.jpg',
				priority: 0,
				social: {
					facebook: '',
					twitter: '',
