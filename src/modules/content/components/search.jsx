			...
			return [
				{
					...
					source: "via hamburg.edupool.net"
				}, {
					id: 8,
									...
									<div className="col-sm-4">
										<div className="card">
											...
											<div className="card-block">
												...
												<p>
													<small className="text-muted"> {result.source} | 17. November 2016</small>
												</p>
											</div>
										</div>
									</div>
