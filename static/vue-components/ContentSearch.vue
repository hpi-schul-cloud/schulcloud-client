  ...
  export default {
    ...
    methods: {
      ...
      loadContent() {
        ...
        let path = this.$config.API.searchPath + `?$limit=${this.pagination.itemsPerPage}&$skip=${this.pagination.itemsPerPage * (this.pagination.page - 1)}${searchString?`&_all[$match]=${searchString}`:''}`;
