import "./dataprivacy";
import "./registration-link-validation.js";
...
window.addEventListener("DOMContentLoaded", () => {
	...
	$("input[readonly]").click(() => {
		...
		$.showNotification(
			"Diese Daten hat deine Lehrkraft oder dein Administrator für dich eingetragen. Falls Anpassungen notwendig sind wende dich bitte an ihn/sie. Du kannst deine Daten auch nach abgeschlossenem Registrierungsprozess selbst ändern.",
			"danger",
			false
		);
	});
