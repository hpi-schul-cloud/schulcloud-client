...
$(document).ready(function() {
    ...
    function getSelectionIndex() {
        ...
        return radioButtons.indexOf(radioButtons.filter((node) => {
            return node.checked;
        })[0]) + 1;
    }
    ...
    function submitForm(event) {
        ...
        if(this.checkValidity()) {
            ...
            console.log(this.getAttribute("action"), this.getAttribute("method"));
            $.ajax({
    ...
    function nextSection(event) {
        console.log(getSelectionIndex(), document.querySelector(`section[data-panel="section-${getSelectionIndex()}"]`))
        ...
        if(!submitPage) {
            ...
            console.log("no reaction -> should submit");
        }
    ...
    // all DOMContentLoaded subhandler together
