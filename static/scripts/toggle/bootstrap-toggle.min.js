...
+(function (a) {
		...
		(c.prototype.render = function () {
			...
			const b =
				this.options.size === "large"
					...
					? "btn-mini"
					: "";
			const c = a('<label class="btn">')
				.html(this.options.on)
				.addClass(`${this._onstyle} ${b}`);
			const d = a('<label class="btn">')
				.html(this.options.off)
				.addClass(`${this._offstyle} ${b} active`);
			const e = a(
				'<span class="toggle-handle btn btn-default">'
			).addClass(b);
			const f = a('<div class="toggle-group">').append(c, d, e);
			const g = a('<div class="toggle btn" data-toggle="toggle">')
				.addClass(
			...
			const i = this.options.height || Math.max(c.height(), d.height());
	...
	(a.fn.bootstrapToggle = b),
		...
		a(document).on("click.bs.toggle", "div[data-toggle^=toggle]", function (
			...
			const c = a(this).find("input[type=checkbox]");
