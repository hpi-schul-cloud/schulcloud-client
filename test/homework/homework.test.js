        ...
        return new Promise((resolve, reject) => {
            this.agent
                ...
                .end((err, res) => {
                    ...
                    expect(res.text).to.not.contain('sc-btn sc-btn-secondary sc-btn-sm sc-btn-edit');
                    expect(res.text).to.not.contain('sc-btn sc-btn-secondary sc-btn-sm sc-btn-delete');
                    resolve();
                });
        });
    });
        ...
        return new Promise((resolve, reject) => {
            this.agent
                ...
                .end((err, res) => {
                    ...
                    expect(res.text).to.contain('sc-btn sc-btn-secondary sc-btn-sm sc-btn-edit');
                    expect(res.text).to.contain('sc-btn sc-btn-secondary sc-btn-sm sc-btn-delete');
                    resolve();
                });
        });
    });
