...
describe('date helper', () => {
	it('should normalize a given date string', () => {
		expect(normalizeDate('20.01.2004', 'de')).to.eq('2004-01-20');
		expect(normalizeDate('01/20/2004', 'en')).to.eq('2004-01-20');
		expect(normalizeDate('01/20/2004', 'es')).to.eq('2004-01-20');
	});
	...
	it('should throw if the date string is invalid', () => {
		expect(() => normalizeDate('20/01.2004')).to.throw();
		expect(() => normalizeDate('01/20/2004')).to.throw();
